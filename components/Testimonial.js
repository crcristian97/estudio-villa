    ...
    <section className="bg-white">
      <div className="w-full mx-auto max-w-xl flex flex-col justify-center py-24 relative p-8">
        <div className="prose text-gray-500 prose-sm prose-headings:font-normal prose-headings:text-xl">
          <div>
            <h1 className="text-4xl sm:text-5xl font-extrabold text-[#1D2D44] mb-2 text-center">
              Testimonios
            </h1>
            <p className="text-lg sm:text-xl font-semibold text-[#3E5C76] text-center">
              Lo que dicen nuestros clientes
            </p>
          </div>
        </div>
        <div className="mt-6 border-t pt-12 max-w-xl mx-auto">
          {/* Carousel */}
            ...
            >
              ...
              <div className="flex items-center justify-center mb-2 gap-4">
                <ArrowCircle
                  ...
                  disabled={current === 0}
                />
                <div className="items-center inline-flex lg:px-2 space-x-2 justify-center">
              ...
              <ul
                className="flex gap-3 mt-4 snap-mandatory snap-x w-full rounded-2xl"
                role="listbox"
                        ...
                        <div className="flex flex-col gap-12">
                          ...
                          <div className="block flex-shrink-0">
                            <div className="flex items-center">
                              {/* Avatar removed */}
                              <div>
                                <p className="text-sm font-medium" style={{ color: iColor }}>
                                  {t.name}
                                </p>
